...
#  Key variables:
#  
#  age      age at intake in year 1
#  yrsill   years since diagnosis at intake in year 1
#  pos      scale for 'positive' symptoms
#  neg      scale for 'negative' symptoms
#  gen      scale for other symptoms
#  total    total of previous scales
#  year     year of study: 1 to 6
#  drug     drug used in previous year
